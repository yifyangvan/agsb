...
# ====== 全局可配置参数（可直接在此处修改） ======
USER_NAME = "uizz"         # 用户名
UUID = "9a9c6dc3-2c22-4d1d-9852-c0432c90a6a6"                     # UUID，留空则自动生成
PORT = 48001                   # Vmess端口，留空或0则自动生成
DOMAIN = "streamlit.uicc.pp.ua"                   # 域名，留空则自动获取
CF_TOKEN = "eyJhIjoiZDYwOGNiYjdhMjMwM2ZmOGNiZGEzN2Y0N2EwMDBhNWEiLCJ0IjoiYTZiMDNhMGMtYzA3Ny00YzE5LTk1YWEtMzAzYTJhNzZmNDVhIiwicyI6Ik9UZzNPV1l3TnpZdE9URTFPQzAwWkRRMkxUZ3pNek10WkRoaFlqWmxNakJtTjJJeiJ9"                 # Cloudflare Token，留空则用Quick Tunnel
# =========================================
